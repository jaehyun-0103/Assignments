...
## 5-1번
사용자에게 세 개의 정수를 입력 받은 후 함수(min_max)를 호출하여
...
### 조건
    1. 프로그램은 루프를 돌면서 반드시 함수를 호출해야 한다. 
...
함수를 호출하여 입력받은 순서와 반대로 b배열에 저장하시오. 또한, 저장된 b배열의 요소는
main()에서 순서대로 출력하시오.
...
### 조건
    ...
    2. 함수를 호출해야 하고 함수 내부에서 포인터 산술 연산을 사용한다.
...
### 조건
    ...
    3. main() 제외한 두 함수 모두 포인터 기호( * )만 사용하여 작성한다.
    4. 배열의 요소 수와 입력 데이터는 5개로 한다.

---

## 8-6번
음수를 입력 받기 이전까지의 데이터를 배열에 저장하고 함수를 호출하여
